...
export default function Register() {
  ...
  return (
    ...
    <form className="home-form-form" id="home-form-form">
      ...
      <input name="firstName" placeholder="Your first name" onInput={(e) => setFirstName(e.target.value)}></input>

      <input name="lastName" placeholder="Your last name" onInput={(e) => setLastName(e.target.value)}></input>

        <select name="gender" id="gender" form="home-form-form" onChange={(e) => setGender(e.target.value.toUpperCase())}>
      ...
      <input name="phone" placeholder="Your phone number" onInput={(e) => setPhoneNumber(e.target.value)}></input>
      
      <input name="dob" type={"date"} id="dob" onChange={(e) => setBirthDate(e.target.value)}></input>
     
      <div className="isTasker-checkbox">
        <input name="isTasker" type={"checkbox"} id="isTasker" onChange={(e) => setIsTasker(e.target.checked)}></input>
